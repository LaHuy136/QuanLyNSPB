...
<head>
    ...
    <title>Xóa tất cả nhân viên</title>
</head>
<body>
<?php 
    ...
    echo '<form method="post" action="xulyxoatatcanv.php">';
    ...
    echo '<tr> <td align="right" colspan="5"><input type="submit" value="Xóa nhân viên"></td> </tr>';
    echo '</table>';
    echo '</form>';
